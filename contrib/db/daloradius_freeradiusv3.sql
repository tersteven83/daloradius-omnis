...
CREATE TABLE IF NOT EXISTS `dictionary` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9721 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(9718, 'integer', 'Bandwidth-Max-Up', NULL, NULL, 'pfSense', NULL, NULL, NULL, NULL),
(9719, 'integer', 'Bandwidth-Max-Down', NULL, NULL, 'pfSense', NULL, NULL, NULL, NULL),
(9720, 'integer', 'Max-Total-Octets', NULL, NULL, 'pfSense', NULL, NULL, NULL, NULL);
...
(6, 'administrator', 'radius', '', '', '', '', '', '', '', '', '', '', '', '', '2023-12-04 17:06:22', '2009-12-07 20:12:33', 'admin', '2009-12-07 20:14:01', 'administrator');
...
--
DELIMITER $$
CREATE TRIGGER `voucher_delete` AFTER DELETE ON `radcheck` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `voucher_insert` AFTER INSERT ON `radcheck` FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `userinfo` (
  ...
  `updatedate` datetime DEFAULT '0000-00-00 00:00:00',
  `updateby` varchar(128) DEFAULT NULL,
  `tmp_passcode` varchar(6) DEFAULT NULL,
  `can_be_edited` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'status of editing user password',
  PRIMARY KEY (`id`),
  KEY `username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
